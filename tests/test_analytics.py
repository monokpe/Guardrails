...
def setup_analytics_data(db_session):
    ...
    api_key_a = models.APIKey(tenant_id=tenant_a.id, customer_id=customer_a.id, key_hash=key_hash_a, name="Key A")
    ...
    api_key_b = models.APIKey(tenant_id=tenant_b.id, customer_id=customer_b.id, key_hash=key_hash_b, name="Key B")
